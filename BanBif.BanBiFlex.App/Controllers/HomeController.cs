...
namespace BanBif.BanBiFlex.App.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult IniciarSesion(LoginRequest request)
        {
            string apiBaseUrl = ConfigurationManager.AppSettings.Get("UrlAPI").ToString();
            string apiUrl = apiBaseUrl + "api/BanBiflex/Login";
            ...
            using (var client = new HttpClient())
            {
                ...
                var resultado = JsonConvert.DeserializeObject<LoginResponse>(dataObjects);
